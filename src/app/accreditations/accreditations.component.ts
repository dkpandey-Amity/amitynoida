...
export class AccreditationsComponent implements OnInit {
  ...
  updateMetaTags(): void {
    this.apiService.getAccreditationsMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Accreditations – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Details about national and international accreditations awarded to Amity University Noida.',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/accreditations`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Accreditations',
          description:
            metaData.Description ||
            'Details about national and international accreditations awarded to Amity University Noida.',
          isPartOf: {
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading private university offering globally benchmarked education.',
          ...
          sameAs: [
            'https://www.facebook.com/AmityUniversityNoida',
