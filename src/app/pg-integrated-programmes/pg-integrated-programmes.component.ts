...
@Component({
  selector: 'app-pg-integrated-programmes',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './pg-integrated-programmes.component.html',
  styleUrl: './pg-integrated-programmes.component.css',
})
export class PgIntegratedProgrammesComponent implements OnInit {
  ...
  getAllIntegratedPgPrograms() {
    this.apiService.getIntegratedPgPrograms().subscribe((data: any) => {
      ...
      if (pageData) {
        ...
        const title =
          pageData.Title || 'Integrated PG Programmes – Amity University Noida';

        const description =
          pageData.Description ||
          'Explore integrated postgraduate programmes at Amity University Noida combining multidisciplinary learning and advanced academic pathways.';
  ...
  injectStructuredData(pageData: any): void {
    ...
    const pageUrl =
      pageData.CanonicalUrl || `${baseUrl}/integrated-pg-programmes`;
      ...
      '@graph': [
        {
          ...
          name:
            pageData.Title ||
            'Integrated PG Programmes – Amity University Noida',
          description:
            pageData.Description ||
            'Explore all integrated postgraduate programmes offered at Amity University Noida.',
          isPartOf: { '@id': `${baseUrl}/#organization` },
          breadcrumb: { '@id': `${pageUrl}#breadcrumb` },
          mainEntity: { '@id': `${pageUrl}#integrated-pg-list` },
        },

        {
          '@type': 'ItemList',
          '@id': `${pageUrl}#integrated-pg-list`,
          name: 'Integrated PG Programmes List',
          itemListOrder: 'https://schema.org/ItemListOrderAscending',
          itemListElement: this.PGIntegratedData?.map(
            (program: any, index: number) => ({
              ...
              item: {
                ...
                description:
                  program.Description ||
                  'Integrated postgraduate programme offered by Amity University Noida.',
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading private university offering integrated undergraduate and postgraduate programmes across disciplines.',
        },
