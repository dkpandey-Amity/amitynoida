...
@Component({
  selector: 'app-campus-security',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './campus-security.component.html',
  styleUrl: './campus-security.component.css',
})
export class CampusSecurityComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getcampusSecurityMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Campus Security – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Learn about the advanced campus security systems, safety protocols, emergency response units, and 24/7 surveillance at Amity University Noida.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Campus Security – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/campus-security`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Campus Security – Amity University Noida',
          description:
            metaData.Description ||
            'Learn about the advanced campus security systems, safety protocols, emergency response units, and 24/7 surveillance at Amity University Noida.',
          isPartOf: {
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading private university offering world-class education, research, and campus facilities.',
