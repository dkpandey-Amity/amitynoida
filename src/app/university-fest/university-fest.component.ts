...
@Component({
  selector: 'app-university-fest',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './university-fest.component.html',
  styleUrl: './university-fest.component.css',
})
export class UniversityFestComponent implements AfterViewInit {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getUniversityFestMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'University Fest – Amity University Noida';

          const description =
            metaData.Description ||
            'Explore the University Fest at Amity University Noida featuring cultural events, music, performances, competitions, and student celebrations.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl = metaData.CanonicalUrl || `${baseUrl}/university-fest`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= EVENT ================= */
        {
          ...
          '@id': canonicalUrl,
          url: canonicalUrl,
          name: metaData.Title || 'University Fest',
          description:
            metaData.Description ||
            'Annual university fest celebrating cultural, musical, and artistic talent.',
          startDate: metaData.StartDate || '2024-11-15T18:00',
          endDate: metaData.EndDate || '2024-11-15T22:00',
          eventStatus: 'https://schema.org/EventScheduled',
          eventAttendanceMode: 'https://schema.org/OfflineEventAttendanceMode',
          location: {
            '@type': 'Place',
            name: 'Amity University Noida Central Stage',
            address: {
              '@type': 'PostalAddress',
          ...
          breadcrumb: { '@id': `${canonicalUrl}#breadcrumb-university-fest` },
        },
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida organizes its annual University Fest showcasing student talent, creativity, and cultural diversity.',
        },

        /* ================= BREADCRUMB ================= */
        {
          '@type': 'BreadcrumbList',
          '@id': `${canonicalUrl}#breadcrumb-university-fest`,
          itemListElement: [
            {
              '@type': 'ListItem',
              position: 1,
