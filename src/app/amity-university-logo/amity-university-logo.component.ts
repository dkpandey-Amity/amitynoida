...
@Component({
  selector: 'app-amity-university-logo',
  standalone: true,
  imports: [],
  templateUrl: './amity-university-logo.component.html',
  styleUrl: './amity-university-logo.component.css',
})
export class AmityUniversityLogoComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getAmitylogoMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            ...
            content:
              metaData.Title ||
              'Amity University Logo – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Download and explore the official Amity University Noida logo and branding assets.',
          });
          ...
          this.meta.updateTag({
            property: 'og:image',
            content: 'https://noida.amity.edu/assets/img/amity-logo.png',
          });

          this.meta.updateTag({
            property: 'og:image:alt',
            content: 'Amity University Logo',
          });
