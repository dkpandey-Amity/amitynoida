...
@Component({
  selector: 'app-social-initiatives',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './social-initiatives.component.html',
  styleUrl: './social-initiatives.component.css',
})
export class SocialInitiativesComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getSocialInitiativesMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Social Initiatives – Amity University Noida';

          const description =
            metaData.Description ||
            'Explore social initiatives, CSR activities, sustainability efforts, and community outreach programs led by Amity University Noida.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl =
      metaData.CanonicalUrl || `${baseUrl}/social-initiatives`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= WEBPAGE ================= */
        {
          ...
          '@id': canonicalUrl,
          url: canonicalUrl,
          name: metaData.Title || 'Social Initiatives – Amity University Noida',
          description:
            metaData.Description ||
            'Explore social responsibility initiatives, community outreach programs, sustainability efforts, and CSR activities led by Amity University Noida.',
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida actively engages in social initiatives, CSR programs, sustainability projects, and community development efforts across India.',
          address: {
            '@type': 'PostalAddress',
          ...
          contactPoint: [
            {
              ...
              email: 'csr@amity.edu',
              contactType: 'CSR and Social Initiatives Office',
        ...
        /* ================= BREADCRUMB ================= */
        {
          ...
          itemListElement: [
            ...
            },
            {
              '@type': 'ListItem',
              position: 2,
              name: metaData.Title || 'Social Initiatives',
              item: canonicalUrl,
            },
          ],
        },
