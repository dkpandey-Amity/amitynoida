...
export class IncubatorComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getincubatorMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content: metaData.Title || 'Incubator – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Explore startup incubation, innovation support, and entrepreneurial opportunities at Amity University Noida.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Incubator – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/incubator`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Incubator – Amity University Noida',
          description:
            metaData.Description ||
            'Innovation and startup incubation support at Amity University Noida.',
...

        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida is a leading private university offering innovation-driven education and startup incubation support.',
          address: {
            '@type': 'PostalAddress',
...

        {
          '@type': 'WebApplication',
          '@id': `${pageUrl}#webapp`,
          name: 'Amity University Incubator Platform',
          url: pageUrl,
