...
@Component({
  selector: 'app-linkedin-partnership',
  standalone: true,
  imports: [],
  templateUrl: './linkedin-partnership.component.html',
  styleUrl: './linkedin-partnership.component.css',
})
export class LinkedinPartnershipComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getAcademiaMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'LinkedIn Partnership – Amity University Noida';

          const description =
            metaData.Description ||
            'Discover how Amity University Noida collaborates with LinkedIn to provide students with enhanced career development resources, digital skills, and professional growth opportunities.';
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'LinkedIn Partnership',
          description:
            metaData.Description ||
            'Discover how Amity University Noida collaborates with LinkedIn to provide students with enhanced career development resources, digital skills, and professional growth opportunities.',
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a premier educational institution offering world-class programs and global academic partnerships.',
