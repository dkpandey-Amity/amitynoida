...
@Component({
  selector: 'app-flexible-credit-system',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './flexible-credit-system.component.html',
  styleUrl: './flexible-credit-system.component.css',
})
export class FlexibleCreditSystemComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getflexibleCreditSystemMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            ...
            content:
              metaData.Title ||
              'Flexible Credit System – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Learn about Amity University Noida’s Flexible Credit System, enabling students to customize their academic journey.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Flexible Credit System – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl =
      metaData.CanonicalUrl || `${baseUrl}/flexible-credit-system`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Flexible Credit System',
          description:
            metaData.Description ||
            'Learn about Amity University Noida’s Flexible Credit System, enabling students to customize their academic journey.',
...

        {
          ...
          url: baseUrl,
          description:
            'Amity University Noida is a leading educational institution offering innovative academic frameworks including the Flexible Credit System.',
