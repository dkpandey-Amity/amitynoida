...
@Component({
  selector: 'app-ug-evening-program',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './ug-evening-program.component.html',
  styleUrl: './ug-evening-program.component.css',
})
export class UgEveningProgramComponent implements OnInit {
  UGEveningData: any = [];
  ...
  getAlUGEveningPrograms() {
    this.apiService.getUGEveningPrograms().subscribe((data: any) => {
      ...
      if (pageData) {
        ...
        const title =
          pageData?.Title || 'UG Evening Programmes – Amity University Noida';

        const description =
          pageData?.Description ||
          'Explore undergraduate evening programmes at Amity University Noida designed for working professionals and flexible learning.';
  ...
  injectStructuredData(pageData: any): void {
    ...
    const canonicalUrl =
      pageData.CanonicalUrl || `${baseUrl}/ug-evening-program`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= PAGE ================= */
        {
          ...
          description:
            pageData.Description ||
            'Explore undergraduate evening programmes designed for working professionals at Amity University Noida.',
          isPartOf: { '@id': `${baseUrl}#university` },
          mainEntity: { '@id': `${canonicalUrl}#ug-evening-program-list` },
          breadcrumb: { '@id': `${canonicalUrl}#breadcrumb-ug-evening` },
        },

        /* ================= PROGRAM LIST ================= */
        {
          '@type': 'ItemList',
          '@id': `${canonicalUrl}#ug-evening-program-list`,
          name: 'Undergraduate Evening Programme List',
          itemListOrder: 'https://schema.org/ItemListOrderAscending',
          itemListElement: this.UGEveningData.map(
            (program: any, index: number) => ({
              ...
              item: {
                ...
                description:
                  program.Description ||
                  'Undergraduate evening programme offered by Amity University Noida.',
                programType: 'Undergraduate Evening Program',
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida offers flexible undergraduate evening programmes for working professionals and lifelong learners.',
        },

        /* ================= BREADCRUMB ================= */
        {
          '@type': 'BreadcrumbList',
          '@id': `${canonicalUrl}#breadcrumb-ug-evening`,
          itemListElement: [
            {
              '@type': 'ListItem',
              position: 1,
