...
@Component({
  selector: 'app-behavioral-science',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './behavioral-science.component.html',
  styleUrl: './behavioral-science.component.css',
})
export class BehavioralScienceComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getBehavioralScienceMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Behavioral Science – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Explore Behavioral Science programs at Amity University Noida.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Behavioral Science – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/behavioral-science`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Behavioral Science – Amity University Noida',
          description:
            metaData.Description ||
            'Explore Behavioral Science programs at Amity University Noida.',
          isPartOf: {
...

        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida’s Behavioral Science programs focus on psychology, sociology, and applied research.',
          address: {
            '@type': 'PostalAddress',
