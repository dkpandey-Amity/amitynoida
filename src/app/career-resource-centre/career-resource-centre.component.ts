...
@Component({
  selector: 'app-career-resource-centre',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './career-resource-centre.component.html',
  styleUrl: './career-resource-centre.component.css',
})
export class CareerResourceCentreComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getCareerResourceCentreMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            ...
            content:
              metaData.Title ||
              'Career Resource Centre – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'The Career Resource Centre at Amity University Noida provides placement support, professional development, and industry-focused training for students.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Career Resource Centre – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl =
      metaData.CanonicalUrl || `${baseUrl}/career-resource-centre`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Career Resource Centre',
          description:
            metaData.Description ||
            'The Career Resource Centre at Amity University Noida provides professional development, placement support, and industry-focused resources to students.',
          isPartOf: {
            '@id': `${baseUrl}/#website`,
          },
          breadcrumb: {
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a premier private university offering globally benchmarked education with strong industry integration.',
...

        {
          '@type': 'WebApplication',
          '@id': `${pageUrl}#webapp`,
          name: 'Career Resource Centre Portal',
          url: pageUrl,
        },
