...
export class LeadershipComponent implements OnInit {
  ...
  updateMetaTags(): void {
    this.apiService.getLeadershipPageKeywords().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title = metaData.Title || 'Leadership – Amity University Noida';

          const description =
            metaData.Description ||
            'Meet the leadership team guiding Amity University Noida with vision and excellence.';
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Leadership',
          description:
            metaData.Description ||
            'Meet the leadership team guiding Amity University Noida with vision and excellence.',
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading institution known for academic excellence and global standards.',
        ...
        {
          '@type': 'Person',
          '@id': `${pageUrl}#leadership-person`,
          name: metaData.LeaderName || 'Dr. A. K. Singh',
          jobTitle: metaData.LeaderDesignation || 'Vice Chancellor',
          description:
            metaData.LeaderDescription ||
            'Leads the university with a focus on academic innovation and student success.',
          url: pageUrl,
          worksFor: { '@id': `${baseUrl}/#college` },
        },
