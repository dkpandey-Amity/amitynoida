...
export class QualityComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getQualityMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Quality Standards – Amity University Noida';

          const description =
            metaData.Description ||
            'Learn about Amity University Noida’s quality assurance, accreditation standards, academic excellence, and institutional benchmarks.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl = metaData.CanonicalUrl || `${baseUrl}/quality`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= ABOUT / QUALITY PAGE ================= */
        {
          ...
          '@id': canonicalUrl,
          url: canonicalUrl,
          name: metaData.Title || 'Quality Standards – Amity University Noida',
          description:
            metaData.Description ||
            'Learn about Amity University Noida’s quality assurance processes, accreditation, academic excellence benchmarks, and continuous improvement initiatives.',
          isPartOf: {
            '@id': `${baseUrl}#website`,
          },
          breadcrumb: {
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida is committed to delivering world-class academic quality, innovation, accreditation standards, and institutional excellence.',
          address: {
            '@type': 'PostalAddress',
          ...
          contactPoint: [
            ...
            },
            {
              ...
              email: 'quality@amity.edu',
              contactType: 'quality assurance',
