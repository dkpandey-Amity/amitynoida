...
export class WithdrawalComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getWithdrawalMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Withdrawal Policy – Amity University Noida';

          const description =
            metaData.Description ||
            'View the withdrawal policy, refund rules, and procedures for discontinuing a program at Amity University Noida.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl = metaData.CanonicalUrl || `${baseUrl}/withdrawal`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= PAGE ================= */
        {
          ...
          '@id': canonicalUrl,
          url: canonicalUrl,
          name: metaData.Title || 'Withdrawal Policy – Amity University Noida',
          description:
            metaData.Description ||
            'View the withdrawal rules, refund policies, and procedures for discontinuing a program at Amity University Noida.',
          isPartOf: { '@id': `${baseUrl}#university` },
          breadcrumb: { '@id': `${canonicalUrl}#breadcrumb-withdrawal` },
        },
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            "Amity University Noida is one of India's leading private universities offering high-quality education with global standards.",
          address: {
            '@type': 'PostalAddress',
        ...
        {
          '@type': 'BreadcrumbList',
          '@id': `${canonicalUrl}#breadcrumb-withdrawal`,
          itemListElement: [
            {
              '@type': 'ListItem',
              position: 1,
