...
export class StudentLifeComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getStudentLifeMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Student Life – Amity University Noida';

          const description =
            metaData.Description ||
            'Explore student life at Amity University Noida including campus activities, clubs, sports, housing, wellness, events, and holistic development opportunities.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl = metaData.CanonicalUrl || `${baseUrl}/student-life`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= PAGE ================= */
        {
          ...
          '@id': canonicalUrl,
          url: canonicalUrl,
          name: metaData.Title || 'Student Life – Amity University Noida',
          description:
            metaData.Description ||
            'Explore student life at Amity University Noida including campus activities, clubs, housing, sports, wellness, and holistic development opportunities.',
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida provides a vibrant student life with cultural activities, sports, student clubs, residential facilities, and support services.',
          address: {
            '@type': 'PostalAddress',
          ...
          contactPoint: [
            {
              ...
              contactType: 'student affairs inquiries',
