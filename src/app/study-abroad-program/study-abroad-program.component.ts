...
@Component({
  selector: 'app-study-abroad-program',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './study-abroad-program.component.html',
  styleUrl: './study-abroad-program.component.css',
})
export class StudyAbroadProgramComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getStudyAbroadProgramMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Study Abroad Program – Amity University Noida';

          const description =
            metaData.Description ||
            'Explore study abroad programs at Amity University Noida offering international exposure, global partnerships, student exchange opportunities, and overseas academic experiences.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl =
      metaData.CanonicalUrl || `${baseUrl}/study-abroad-program`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= PAGE ================= */
        {
          ...
          breadcrumb: { '@id': `${canonicalUrl}#breadcrumb-study-abroad` },
        },
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida offers globally connected education through study abroad programs, international collaborations, exchange initiatives, and overseas academic exposure.',
          address: {
            '@type': 'PostalAddress',
        ...
        {
          '@type': 'BreadcrumbList',
          '@id': `${canonicalUrl}#breadcrumb-study-abroad`,
          itemListElement: [
            {
              '@type': 'ListItem',
              position: 1,
