...
@Component({
  ...
  styleUrl: './beyond-academics.component.css',
})
export class BeyondAcademicsComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getBeyondAcademicsMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Beyond Academics – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Explore Beyond Academics at Amity University Noida including student clubs, extracurricular activities, leadership programs, and holistic development opportunities.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Beyond Academics – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/beyond-academics`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Beyond Academics – Amity University Noida',
          description:
            metaData.Description ||
            'Explore Beyond Academics at Amity University Noida, including skill development, student clubs, extracurricular activities, leadership programs, and holistic growth opportunities.',
          isPartOf: {
            '@id': `${baseUrl}/#website`,
          },
          breadcrumb: {
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida fosters holistic development through extracurricular programs, industry exposure, innovation-driven learning, and leadership-building opportunities.',
