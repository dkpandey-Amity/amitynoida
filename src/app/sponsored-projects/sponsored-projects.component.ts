...
@Component({
  selector: 'app-sponsored-projects',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './sponsored-projects.component.html',
  styleUrl: './sponsored-projects.component.css',
})
export class SponsoredProjectsComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getSponsoredProjectsMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Sponsored Projects – Amity University Noida';

          const description =
            metaData.Description ||
            'Explore sponsored research projects at Amity University Noida including government-funded, industry-sponsored, and collaborative research initiatives.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl =
      metaData.CanonicalUrl || `${baseUrl}/sponsored-projects`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= WEBPAGE ================= */
        {
          ...
          name:
            metaData.Title ||
            'Sponsored Research Projects – Amity University Noida',
          description:
            metaData.Description ||
            'Explore sponsored research projects at Amity University Noida including government-funded, industry-sponsored, and collaborative research initiatives.',
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida undertakes sponsored research projects in collaboration with government agencies, industry partners, and international research organizations.',
          address: {
            '@type': 'PostalAddress',
          ...
          contactPoint: [
            {
              ...
              contactType: 'research & sponsored projects office',
