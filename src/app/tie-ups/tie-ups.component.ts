...
@Component({
  selector: 'app-tie-ups',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './tie-ups.component.html',
  styleUrl: './tie-ups.component.css',
})
export class TieUpsComponent {
  constructor(
    private meta: Meta,
  ...
  updateMetaTags(): void {
    this.apiService.getTieupsMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          const title =
            metaData.Title || 'Institutional Tie-ups – Amity University Noida';

          const description =
            metaData.Description ||
            'Explore institutional tie-ups of Amity University Noida with global universities, research organizations, and industry partners for academic excellence and collaboration.';
  ...
  injectStructuredData(metaData: any): void {
    ...
    const canonicalUrl = metaData.CanonicalUrl || `${baseUrl}/tie-ups`;
    ...
    const schema = {
      ...
      '@graph': [
        /* ================= PAGE ================= */
        {
          ...
          description:
            metaData.Description ||
            'Explore national and international tie-ups between Amity University Noida and leading academic institutions, research bodies, industries, and global organizations.',
          isPartOf: { '@id': `${baseUrl}#university` },
          breadcrumb: { '@id': `${canonicalUrl}#breadcrumb-tieups` },
        },
        ...
        /* ================= UNIVERSITY ================= */
        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida has established collaborations with universities, industries, and research organizations globally, promoting student exchange, joint research, and academic development.',
          address: {
            '@type': 'PostalAddress',
          ...
          contactPoint: [
            {
              ...
              contactType: 'international collaborations',
        ...
        {
          '@type': 'BreadcrumbList',
          '@id': `${canonicalUrl}#breadcrumb-tieups`,
          itemListElement: [
            {
              '@type': 'ListItem',
              position: 1,
