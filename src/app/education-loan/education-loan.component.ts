...
export class EducationLoanComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getEducationLoanMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Education Loan – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Explore student-centric education loan options, EMI plans, and banking partners available at Amity University Noida.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Education Loan – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/education-loan`;
      ...
      '@graph': [
        {
          ...
          '@id': `${pageUrl}#webpage`,
          url: pageUrl,
          name: metaData.Title || 'Education Loan – Amity University Noida',
          description:
            metaData.Description ||
            'Explore student-centric education loan options and partnered financial institutions at Amity University Noida.',
          isPartOf: {
            '@id': `${baseUrl}/#website`,
          },
          breadcrumb: {
          ...
          mainEntity: {
            '@id': `${pageUrl}#education-loan-product`,
          },
        },

        {
          ...
          '@id': `${pageUrl}#education-loan-product`,
          name: 'Education Loan Options for Students',
          description:
            'Financial assistance and education loan options offered through partnered national banks.',
          provider: {
            '@type': 'Organization',
            name: 'Amity University Noida – Financial Assistance Cell',
            url: pageUrl,
          },
          offers: [
            {
              '@type': 'Offer',
              name: 'Student Education Loan – HDFC Credila',
              description:
                'Low-interest education loans with flexible repayment options.',
              url: pageUrl,
            },
            {
              '@type': 'Offer',
              name: 'Student Loan – State Bank of India',
              description:
                'Affordable EMI options for undergraduate and postgraduate programs.',
              url: pageUrl,
            },
          ],
        },

        {
          ...
          foundingDate: '2005',
          description:
            'Amity University Noida provides financial support to students through multiple recognized loan partners.',
          address: {
            '@type': 'PostalAddress',
          ...
          contactPoint: [
            {
              ...
              email: 'finance@amity.edu',
              contactType: 'financial assistance',
              areaServed: 'IN',
            },
            {
              '@type': 'ContactPoint',
