...
@Component({
  ...
  templateUrl: './pg-international-programmes-details.component.html',
  styleUrl: './pg-international-programmes-details.component.css',
})
export class PgInternationalProgrammesDetailsComponent implements OnInit {
  GetPGInternationalProgramsData: any[] = [];
  sDiscipline!: string;
  sCourseCode!: string;
