...
export class HigherEducationComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getHigherEducationMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Higher Education – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Explore the wide range of higher education opportunities, academic pathways, and advanced learning options at Amity University Noida.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Higher Education – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/higher-education`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Higher Education',
          description:
            metaData.Description ||
            'Explore the wide range of higher education opportunities, academic pathways, and advanced learning options at Amity University Noida.',
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading institution offering world-class higher education across diverse disciplines.',
          logo: 'https://noida.amity.edu/assets/images/logo.png',
          foundingDate: '2005',
          address: {
            '@type': 'PostalAddress',
            streetAddress: 'Amity Road, Sector 125',
          ...
          sameAs: [
            'https://www.facebook.com/amityuniversity',
