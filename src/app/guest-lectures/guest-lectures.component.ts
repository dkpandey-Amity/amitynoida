...
@Component({
  ...
  styleUrl: './guest-lectures.component.css',
})
export class GuestLecturesComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getGuestLecturesMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content:
              metaData.Title || 'Guest Lectures – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Discover upcoming and past guest lectures conducted by industry experts at Amity University Noida.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Guest Lectures – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/guest-lectures`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Guest Lectures',
          description:
            metaData.Description ||
            'Discover upcoming and past guest lectures conducted by industry experts at Amity University Noida.',
...

        {
          ...
          itemListElement: [
            {
              '@type': 'Event',
              name: 'Leadership in the Digital Age – By Dr. Rajesh Mehta',
              ...
              location: {
                '@type': 'Place',
                name: 'Amity University Noida – Auditorium Block',
                address: {
                  '@type': 'PostalAddress',
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading private university offering globally benchmarked education and state-of-the-art academic infrastructure.',
