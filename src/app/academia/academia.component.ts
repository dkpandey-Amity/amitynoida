...
export class AcademiaComponent {
    ...
    this.apiService.getAcademiaMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content: metaData.Title || 'Academia – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Explore the academic ecosystem at Amity University Noida, including schools, departments, teaching methodology, and academic excellence.',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/academia`;
      ...
      '@graph': [
        {
          ...
          '@id': `${pageUrl}#webpage`,
          url: pageUrl,
          name: metaData.Title || 'Academia – Amity University Noida',
          description:
            metaData.Description ||
            'Explore the academic ecosystem at Amity University Noida, including schools, departments, teaching methodology, and academic excellence.',
          isPartOf: {
...

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading private university in India offering world-class education, research, and industry-aligned programs.',
          logo: {
            '@type': 'ImageObject',
