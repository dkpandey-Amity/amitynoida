...
@Component({
  ...
  styleUrl: './career-test.component.css',
})
export class CareerTestComponent {
  ...
  updateMetaTags(): void {
    this.apiService.getCareertestMeta().subscribe({
      next: (data: any[]) => {
        if (Array.isArray(data) && data.length > 0) {
          ...
          this.meta.updateTag({
            property: 'og:title',
            content: metaData.Title || 'Career Test – Amity University Noida',
          });
          ...
          this.meta.updateTag({
            ...
            content:
              ...
              'Take the Career Test to discover suitable career paths based on your interests, skills, and aptitude.',
          });
          ...
          this.meta.updateTag({
            ...
            content: 'Career Test – Amity University Noida',
          });
  ...
  injectStructuredData(metaData: any): void {
    ...
    const pageUrl = metaData.CanonicalUrl || `${baseUrl}/admission-career-test`;
      ...
      '@graph': [
        {
          ...
          '@id': pageUrl,
          url: pageUrl,
          name: metaData.Title || 'Career Test – Amity University Noida',
          description:
            metaData.Description ||
            'Take the Career Test to discover suitable career paths based on your interests, skills, and aptitude.',
          isPartOf: {
        ...
        {
          '@type': 'WebApplication',
          '@id': `${baseUrl}/#career-test-app`,
          name: 'Career Test Application',
          url: pageUrl,
          applicationCategory: 'EducationalApplication',
          operatingSystem: 'All',
          description:
            'An interactive tool that evaluates career preferences and offers personalized career recommendations.',
        },

        {
          ...
          url: `${baseUrl}/`,
          description:
            'Amity University Noida is a leading institution offering comprehensive academic programs and career development resources.',
